        ...
        <div class="c-fi-wrapper">
            <div class="c-fi-grid">
                <div class="c-fi-cell hero">
                    <a class="c-fi-link ga-event" data-event-action="Feature Hero Image Click" href="/onlineservices/" style="background-image:url(/ΙΚΑ/img/security-cover.jpg)">
                ...
                <div class="c-fi-cell">
                    <div class="c-fi-grid nested">
                        <div class="c-fi-cell">
                            <a class="c-fi-link ga-event" data-event-action="Feature Image Click" href="/IKA/pension.php/" style="background-image:url(/ΙΚΑ/img/pension-cover.jpg)">
                                <div class="c-fi-text">Σύνταξη</div>
                            </a>
                        </div>
                        <div class="c-fi-cell">
                            <a class="c-fi-link ga-event" data-event-action="Feature Image Click" href="/IKA/business.php/" style="background-image:url(/ΙΚΑ/img/work-cover.jpg)">
                                <div class="c-fi-text">Εργοδοσία</div>
                            </a>
                        </div>
                        <div class="c-fi-cell">
                            <a class="c-fi-link ga-event" data-event-action="Feature Image Click" href="/benefits/medicare/prescriptionhelp/" style="background-image:url(/ΙΚΑ/img/debt-cover.jpg)">
                                <div class="c-fi-text">Οφειλές</div>
                            </a>
                        </div>
                        <div class="c-fi-cell">
                            <a class="c-fi-link ga-event" data-event-action="Feature Image Click" href="https://faq.ssa.gov/ics/support/KBAnswer.asp?questionID=3704" style="background-image:url(/ΙΚΑ/img/disability-cover.jpg)">
        ...
        <div class="m-row">
          ...
          <div class="mb3 m-col m-fx m-ta-c l-w-25">
            <a class=" selection-sub-menu bg-white bs1 db ga-event pa3 l-bg-clear l-bs0 l-pa0" data-event-action="Feature Icon Click" data-event-label="Social Security Number" href="/ssnumber/">
              <img alt="" class="dn m-db mx-auto my3 svg6" src="/ΙΚΑ/img/newsfeed.png">
          ...
          <div class="mb3 m-col m-fx m-ta-c l-w-25">
              <a class="selection-sub-menu bg-white bs1 db ga-event pa3 l-bg-clear l-bs0 l-pa0" data-event-action="Feature Icon Click" data-event-label="my Social Security" href="/myaccount/">
                  <img alt="" class="dn m-db mx-auto my3 svg6" src="/ΙΚΑ/img/faq.png">
          ...
          <div class="mb3 m-col m-fx m-ta-c m-mb0  l-w-25">
            <a class="selection-sub-menu bg-white bs1 db ga-event pa3 l-bg-clear l-bs0 l-pa0" data-event-action="Feature Icon Click" data-event-label="Frequently Asked Questions" href="/ask/">
              <img alt="" class="dn m-db mx-auto my3 svg6" src="/ΙΚΑ/img/contact.png">
